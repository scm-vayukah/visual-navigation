...
# Enable GDAL exceptions and logging
gdal.UseExceptions()
...
def process_images(ortho_path, drone_paths, output_root):
    # Load ortho image in downsampled form
    ...
    # Downsample ortho image to prevent OOM
    buf_xsize = 1024
    ...
    # Handle multi-band or single-band image
    ...
    output_version = os.path.join(output_root, "sift_v1")
    os.makedirs(output_version, exist_ok=True)
...
if __name__ == "__main__":
    ...
    drone_paths = ["drone1.JPG", "drone2.JPG", "drone3.JPG"]  # You can modify this list
    output_folder = "output"
    process_images(ortho_image_path, drone_paths, output_folder)
